...
INSERT INTO suppliers (id, company_name, contact_name, contact_phone, address_id) VALUES
                                                                                 (1,'ABC Corp', 'John Doe', '555-1234-1', 1),
                                                                                 (2,'Tech Solutions Inc', 'Alice Brown', '555-1234-4', 2);

INSERT INTO products (supplier_id, category_id, unit_id, name, quantity, purchase_price, sale_price) VALUES
                                                                                                         (1,1,1,'Laptop', 0, 800.00, 1200.00),
