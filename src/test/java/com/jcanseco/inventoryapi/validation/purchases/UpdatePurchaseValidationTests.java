...
public class UpdatePurchaseValidationTests {
    ...
    @Test
    public void updatePurchaseDtoWhenDtoIsValidValidationShouldNotFail() {
    ...
    public void updatePurchaseWhenDtoIsInvalidValidationShouldFail(Long purchaseId, HashMap<Long, Long> productsWithQuantities) {
        var dto = UpdatePurchaseDto.builder()
