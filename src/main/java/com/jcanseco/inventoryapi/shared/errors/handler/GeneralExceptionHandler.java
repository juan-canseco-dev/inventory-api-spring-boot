package com.jcanseco.inventoryapi.shared.errors.handler;
...
public class  GeneralExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleConstraintViolationException(Exception exception, WebRequest request) {
        logger.error("Data integrity violation while processing request. The record is likely referenced by other data and cannot be modified or deleted.", exception);
        return buildErrorResponse(exception, "We couldn’t complete this action because this item is linked to other information", HttpStatus.CONFLICT, request);
    }
